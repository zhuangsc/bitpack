  ...
  /*                          false if not or if it is invalid.                                                       */
{
    ...
    /* Sign does matter */
      ...
      if (element_type == 0) {
        ...
        /* Gather bits by bytes compare_valid_left_shift_right0..15 */
         ...
         #else
          vector unsigned char gbb0 = VEC_GB (compare_valid_left_shift_right0);
          vector unsigned char gbb1 = VEC_GB (compare_valid_left_shift_right1);
          vector unsigned char gbb2 = VEC_GB (compare_valid_left_shift_right2);
          vector unsigned char gbb3 = VEC_GB (compare_valid_left_shift_right3);
          vector unsigned char gbb4 = VEC_GB (compare_valid_left_shift_right4);
          vector unsigned char gbb5 = VEC_GB (compare_valid_left_shift_right5);
          vector unsigned char gbb6 = VEC_GB (compare_valid_left_shift_right6);
          vector unsigned char gbb7 = VEC_GB (compare_valid_left_shift_right7);
          vector unsigned char gbb8 = VEC_GB (compare_valid_left_shift_right8);
          vector unsigned char gbb9 = VEC_GB (compare_valid_left_shift_right9);
          vector unsigned char gbb10 = VEC_GB (compare_valid_left_shift_right10);
          vector unsigned char gbb11 = VEC_GB (compare_valid_left_shift_right11);
          vector unsigned char gbb12 = VEC_GB (compare_valid_left_shift_right12);
          vector unsigned char gbb13 = VEC_GB (compare_valid_left_shift_right13);
          vector unsigned char gbb14 = VEC_GB (compare_valid_left_shift_right14);
          vector unsigned char gbb15 = VEC_GB (compare_valid_left_shift_right15);
         #endif
        #endif
        ...
        /* Calculate mask for substring match */
         ...
         #else
          vector unsigned char gbb_substring = VEC_GB (left_valid_byte_mask);
         #endif
        #endif
        /* Puts byte 0 of gbb_substring into even bytes and byte 8 into odd bytes */
        ...
        /* Calculate mask for substring match */
         ...
         #endif
        #endif
        /* Put byte 0 of gbb_substring into even bytes and byte 8 into odd bytes */
        vector unsigned char substring_permute_mask = (vector unsigned char) { 0x00,0x08, 0x00,0x08, 0x00,0x08, 0x00,0x08, 0x00,0x08, 0x00,0x08, 0x00,0x08, 0x00,0x08 };
        vector unsigned char substring_mask = vec_perm (gbb_substring, gbb_substring, substring_permute_mask);
  ...
  if (bit_or_element == 0) {
    ...
    /* Bit-transpose each half of result_mask, using Power8 vector gather bits by bytes by doubleword */
       ...
       #else
        bit_transposed_mask = VEC_GB (result_mask_to_transpose);
       #endif
      #endif
    #else
